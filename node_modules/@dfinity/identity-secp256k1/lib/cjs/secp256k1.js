...
class Secp256k1PublicKey {
    static fromRaw(rawKey) {
        return new Secp256k1PublicKey((0, agent_1.bufFromBufLike)(rawKey));
    }
    ...
    static derEncode(publicKey) {
        const key = (0, agent_1.bufFromBufLike)((0, der_1.wrapDER)(publicKey, der_1.SECP256K1_OID).buffer);
    ...
    constructor(key) {
        ...
        __classPrivateFieldSet(this, _Secp256k1PublicKey_rawKey, (0, agent_1.bufFromBufLike)(key), "f");
...
class Secp256k1KeyIdentity extends agent_1.SignIdentity {
    ...
    static generate(seed) {
        ...
        if (seed) {
            ...
            privateKey = new Uint8Array((0, utils_1.randomBytes)(32));
    ...
    static fromParsedJson(obj) {
        ...
        return new Secp256k1KeyIdentity(Secp256k1PublicKey.fromRaw((0, agent_1.fromHex)(publicKeyRaw)), (0, agent_1.fromHex)(privateKeyRaw));
    }
    ...
    static fromSecretKey(secretKey) {
        const publicKey = secp256k1_1.secp256k1.getPublicKey(new Uint8Array(secretKey), false);
    ...
    static fromSeedPhrase(seedPhrase, password) {
        ...
        return Secp256k1KeyIdentity.fromSecretKey((0, agent_1.bufFromBufLike)(addrnode.privateKey));
    }
    /**
    ...
    static fromPem(pemKey) {
        const secretKey = (0, pem_1.pemToSecretKey)(pemKey);
     ...
     */
    toJSON() {
        return [(0, agent_1.toHex)(this._publicKey.toRaw()), (0, agent_1.toHex)(this._privateKey)];
    }
    /**
    ...
    async sign(challenge) {
        ...
        const signature = (0, agent_1.uint8ToBuf)(secp256k1_1.secp256k1
