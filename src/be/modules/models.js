...
export const itemsModel = new Model("items", ["iID", "cID", "title", "description", "parties", "type", "isFinalised", "dateCreated", "hash", "fileURL", "meetingDate", "meetingURL", "meetingFileURL"]);
