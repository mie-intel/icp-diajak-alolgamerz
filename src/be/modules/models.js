...
export const itemsModel = new Model("items", ["iID", "cID", "title", "description", "parties", "type", "isFinalised", "dateCreated", "fileName", "fileID", "fileHash", "meetingDate", "meetingURL", "meetingFileID", "meetingEnded"]);
